...
export function CreateProfileModal({ onClose }: Props) {
  ...
  return (
    <div className="modal-overlay">
      <div className="create-profile" onClick={(e) => e.stopPropagation()}>
        <div
          className="cp-banner"
        ...
        <div className="cp-avatar-section">
          <div className="cp-avatar" onClick={() => avatarInputRef.current?.click()}>
            {displayAvatar ? (
        ...
        <div className="cp-form">
          ...
          <div className="cp-bio-wrap">
            ...
            />
            <span className="cp-bio-counter">{bio.length}/200</span>
          </div>
          ...
          <button className="cp-finish" onClick={handleFinish} disabled={saving}>
            {saving ? '...' : 'finish'}
          </button>
